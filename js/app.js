...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product">
      ...
      <h3 class="pb-3 header-title">Price: $${product.price}</h3>
      <div class="d-flex justify-content-around align-items-center py-lg-2">
       <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now ranchy-btn-primary"><i class="bi bi-basket2"></i> Add to cart</button>
       <button id="details-btn" class="ranchy-btn-secondary"><i class="bi bi-list-stars"></i> Details</button></div>
      </div>
      </div>
      `;
